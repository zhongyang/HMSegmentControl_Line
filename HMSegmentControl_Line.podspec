#
#  Be sure to run `pod spec lint HMSegmentControl_Line.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of HMSegmentControl_Line in Markdown format.
  ...
  # Or just: s.author    = "zhongyang"
  # s.authors            = { "zhongyang" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/zhongyang"
